...
exports.MemberInsertPopup = void 0;
var React = __importStar(require("react"));
var PracticeUtilities_1 = require("../utilities/PracticeUtilities");
var core_1 = require("@material-ui/core");
var MemberInsertPopup = /** @class */ (function (_super) {
    __extends(MemberInsertPopup, _super);
    function MemberInsertPopup(props) {
        ...
        _this.handleSubmit = function () {
            if (_this.state.NISTMember.LastName && _this.state.NISTMember.LastName.length > 0) {
                if (_this.state.NISTMember.FirstName && _this.state.NISTMember.FirstName.length > 0) {
                    ...
                    _this.state.NISTMember.CreatedBy = _this.userId;
                    _this.state.NISTMember.CreatedDate = today;
                    _this.state.NISTMember.UpdatedBy = _this.userId;
                    _this.state.NISTMember.UpdatedDate = today;
                    var insertMemberUrl = PracticeUtilities_1.baseApiUrl() + 'NISTMember/Insert';
                    _this.insertMember(insertMemberUrl, _this.state.NISTMember);
                }
                else
        ...
        _this.insertMember = function (url, postData) {
            console.log(url);
            ...
            fetch(url, postRequestOptions).then(function (res) {
                ...
                if (responseData.Id && responseData.Id > 0) {
                    ...
                    alert(_this.state.NISTMember.FirstName + ' ' + _this.state.NISTMember.LastName + "'s has been added successfully");
    ...
    MemberInsertPopup.prototype.render = function () {
        var _this = this;
        return (React.createElement(core_1.Grid, { item: true, xs: 12, style: { textAlign: "left" } },
            React.createElement(core_1.Grid, { item: true, xs: 12, className: "textRight" },
                React.createElement(core_1.Button, { variant: "contained", onClick: function () { _this.handleShow(); }, className: "imgButton btnImgInsert marginRight10", "data-toggle": "tooltip", title: "Add New Member" },
                ...
                React.createElement(core_1.Paper, { className: "ModalDiv" },
                    React.createElement(core_1.Grid, { container: true, spacing: 2 },
                        React.createElement(core_1.Grid, { item: true, xs: 12, sm: 4 },
                            React.createElement(core_1.TextField, { name: "LastName", id: this.state.NISTMember.LastName && this.state.NISTMember.LastName.length > 0 ? '' : 'requiredFieldLabel', placeholder: "Last Name", value: this.state.NISTMember.LastName, onChange: this.handleChange, helperText: "* Last Name", inputProps: { maxLength: 50 } })),
                        React.createElement(core_1.Grid, { item: true, xs: 12, sm: 4 },
                            React.createElement(core_1.TextField, { name: "FirstName", id: this.state.NISTMember.FirstName && this.state.NISTMember.FirstName.length > 0 ? '' : 'requiredFieldLabel', placeholder: "First Name", value: this.state.NISTMember.FirstName, onChange: this.handleChange, helperText: "* First Name", inputProps: { maxLength: 50 } })),
                        React.createElement(core_1.Grid, { item: true, xs: 12, sm: 4 },
                        ...
                        React.createElement(core_1.Grid, { item: true, xs: 12 },
                            React.createElement(core_1.TextField, { name: "Email", id: this.state.NISTMember.Email && this.state.NISTMember.Email.length > 0 && !PracticeUtilities_1.checkEmail(this.state.NISTMember.Email) ? 'requiredFieldLabel' : '', placeholder: "Email", value: this.state.NISTMember.Email, onChange: this.handleChange, helperText: "Email", inputProps: { maxLength: 150 } })),
                        React.createElement(core_1.Grid, { item: true, xs: 12 },
                            React.createElement(core_1.FormControl, { variant: "outlined", className: "selectForm", style: { width: '100%' } },
    ...
    return MemberInsertPopup;
}(React.Component));
exports.MemberInsertPopup = MemberInsertPopup;
//# sourceMappingURL=MemberInsertPopup.js.map